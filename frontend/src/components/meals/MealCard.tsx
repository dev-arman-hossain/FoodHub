...
const MealCard: React.FC<MealCardProps> = ({ meal }) => {
    ...
    return (
        <motion.div
            ...
            viewport={{ once: true }}
            className="group bg-white rounded-3xl overflow-hidden border border-zinc-100 hover:shadow-2xl hover:shadow-orange-500/10 transition-soft"
        >
            ...
            <div className="p-6 space-y-4">
                <div>
                    ...
                    <p className="text-sm text-zinc-500 line-clamp-2 mt-2 font-medium">
                        {meal.description || 'Delicious meal prepared with fresh ingredients by our top providers.'}
                    </p>
                </div>
